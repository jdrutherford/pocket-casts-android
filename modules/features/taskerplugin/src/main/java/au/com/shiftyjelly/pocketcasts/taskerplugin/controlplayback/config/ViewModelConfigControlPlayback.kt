...
class ViewModelConfigControlPlayback @Inject constructor(
    ...
    // New Sleep Timer InputField
    InputField<Int>(LR.string.sleep_timer_minutes, IR.drawable.timer, InputControlPlayback.PlaybackCommand.SleepTimer, { sleepTimerMinutes }, { sleepTimerMinutes = it }),
)
